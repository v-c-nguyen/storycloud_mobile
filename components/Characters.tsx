...
const styles = StyleSheet.create({
  ...
  char11Style: { top: '38%', left: '20%' },
  char12Style: { top: '72%', left: '60%' },
  char13Style: { top: '48%', left: '35%' },
  char14Style: { top: '68%', left: '15%' },
  char15Style: { top: '58%', left: '70%' },
  char16Style: { top: '62%', left: '25%' },
  char17Style: { top: '52%', left: '80%' },
  char18Style: { top: '32%', left: '62%' },
  char19Style: { top: '62%', left: '18%' },
  char20Style: { top: '42%', left: '55%' },
  char21Style: { top: '30%', left: '30%' },
  char22Style: { top: '110%', left: '50%' },
  char23Style: { top: '50%', left: '45%' },
  char24Style: { top: '75%', left: '25%' },
  char25Style: { top: '45%', left: '75%' },
  char26Style: { top: '70%', left: '35%' },
  char27Style: { top: '60%', left: '90%' },
  char28Style: { top: '40%', left: '70%' },
  char29Style: { top: '65%', left: '22%' },
  char30Style: { top: '55%', left: '58%' },
  char31Style: { top: '36%', left: '42%' },
  char32Style: { top: '76%', left: '68%' },
  char33Style: { top: '46%', left: '12%' },
  char34Style: { top: '66%', left: '1%' },
  char35Style: { top: '56%', left: '78%' },
  char36Style: { top: '63%', left: '33%' },
  char37Style: { top: '53%', left: '88%' },
  char38Style: { top: '33%', left: '64%' },
  char39Style: { top: '63%', left: '16%' },
  char40Style: { top: '43%', left: '52%' },
});
