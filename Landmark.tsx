...
const styles = StyleSheet.create({
  ...
  // Static styles for 6 landmark positions with updated 'top' values
  landmark1Style: { top: '40%', left: '15%' },
  landmark2Style: { top: '75%', left: '70%' },
  landmark3Style: { top: '35%', left: '60%' },
  landmark4Style: { top: '70%', left: '5%' },
  landmark5Style: { top: '55%', left: '60%' },
  landmark6Style: { top: '45%', left: '25%' },
});

// An array to hold the data for each landmark
const landmarksData = [
