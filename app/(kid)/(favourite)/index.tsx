    ...
    <>
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          ...
          {/* Header */}
          <ThemedText style={styles.headerTitle}>All your fovourites in one easy place</ThemedText>
          ...
          <ThemedView style={styles.mainContent}>
            <ThemedView style={styles.content}>
              {/* Tab Bar */}
              <ThemedText style={styles.subtitle}>Stories | 7 total</ThemedText>
              <ThemedView style={{flexDirection: 'column', width: '100%', alignItems: 'center', paddingHorizontal: 16, paddingTop: 20}}>
                {
                  storiesData.length > 0 && storiesData.map((story, index) => (
