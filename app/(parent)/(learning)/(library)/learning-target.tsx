...
const learningTargetsData = [
  ...
  {
    title: "Creativity Expression & The Arts",
    image: "5",
    count: 25,
    isFavorite: true,
  },
...
const storiesData = [
  {
    ...
    isBallonYellow: true,
    number: "#1",
    storyTitle: "The Alphabet Adventure",
    seriesTitle: "Language & Literacy",
    duration: 32,
    progress: 20,
    image: "1",
    featured: false,
  ...
  },
  {
    ...
    number: "#2",
    storyTitle: "Counting with Friends",
    seriesTitle: "Numeracy & Problem Solving",
    duration: 32,
    progress: 12,
    image: "2",
    featured: false,
